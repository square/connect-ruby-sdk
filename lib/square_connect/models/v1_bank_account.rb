...
module SquareConnect
  ...
  class V1BankAccount
    ...
    attr_accessor :account_number_suffix
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          account_number_suffix == o.account_number_suffix &&
    ...
    def hash
      [id, merchant_id, bank_name, name, routing_number, account_number_suffix, currency_code, type].hash
    end
