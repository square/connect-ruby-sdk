...
module SquareConnect
  ...
  class ListAdditionalRecipientReceivableRefundsResponse
    ...
    attr_accessor :receivable_refunds
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'receivable_refunds')
        if (value = attributes[:'receivable_refunds']).is_a?(Array)
          self.receivable_refunds = value
        end
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          errors == o.errors &&
          receivable_refunds == o.receivable_refunds &&
          cursor == o.cursor
    end
    ...
    def hash
      [errors, receivable_refunds, cursor].hash
    end
