...
module SquareConnect
  ...
  class UpdateWorkweekConfigResponse
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'workweek_config')
        self.workweek_config = attributes[:'workweek_config']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          workweek_config == o.workweek_config &&
          errors == o.errors
    end
