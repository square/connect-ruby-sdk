...
module SquareConnect
  ...
  class SearchOrdersFulfillmentFilter
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'fulfillment_types')
        if (value = attributes[:'fulfillment_types']).is_a?(Array)
          self.fulfillment_types = value
        end
      end

      if attributes.has_key?(:'fulfillment_states')
        if (value = attributes[:'fulfillment_states']).is_a?(Array)
          self.fulfillment_states = value
        end
      end
    ...
    def list_invalid_properties
      ...
      if @fulfillment_types.nil?
        invalid_properties.push("invalid value for 'fulfillment_types', fulfillment_types cannot be nil.")
      end
    ...
    def valid?
      return false if @fulfillment_types.nil?
      return true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          fulfillment_types == o.fulfillment_types &&
          fulfillment_states == o.fulfillment_states
    end
    ...
    def hash
      [fulfillment_types, fulfillment_states].hash
    end
