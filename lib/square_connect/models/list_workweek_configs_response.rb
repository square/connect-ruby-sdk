...
module SquareConnect
  ...
  class ListWorkweekConfigsResponse
    ...
    attr_accessor :workweek_configs
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'workweek_configs')
        if (value = attributes[:'workweek_configs']).is_a?(Array)
          self.workweek_configs = value
        end
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          workweek_configs == o.workweek_configs &&
          cursor == o.cursor &&
          errors == o.errors
    end
    ...
    def hash
      [workweek_configs, cursor, errors].hash
    end
