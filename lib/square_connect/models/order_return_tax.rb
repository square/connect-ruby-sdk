...
module SquareConnect
  ...
  class OrderReturnTax
    ...
    # Custom attribute writer method with validation
    # @param [Object] source_tax_uid Value to be assigned
    def source_tax_uid=(source_tax_uid)

      if !source_tax_uid.nil? && source_tax_uid.to_s.length > 60
        fail ArgumentError, "invalid value for 'source_tax_uid', the character length must be smaller than or equal to 60."
      end
