...
module SquareConnect
  ...
  class ListEmployeeWagesResponse
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'employee_wages')
        if (value = attributes[:'employee_wages']).is_a?(Array)
          self.employee_wages = value
        end
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          employee_wages == o.employee_wages &&
          cursor == o.cursor &&
          errors == o.errors
    end
    ...
    def hash
      [employee_wages, cursor, errors].hash
    end
