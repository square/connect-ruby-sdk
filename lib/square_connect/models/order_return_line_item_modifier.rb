...
module SquareConnect
  ...
  class OrderReturnLineItemModifier
    ...
    attr_accessor :source_modifier_uid
    ...
    # Custom attribute writer method with validation
    # @param [Object] source_modifier_uid Value to be assigned
    def source_modifier_uid=(source_modifier_uid)

      if !source_modifier_uid.nil? && source_modifier_uid.to_s.length > 60
        fail ArgumentError, "invalid value for 'source_modifier_uid', the character length must be smaller than or equal to 60."
      end
