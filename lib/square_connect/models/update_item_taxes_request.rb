...
module SquareConnect
  ...
  class UpdateItemTaxesRequest
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'taxes_to_enable')
        if (value = attributes[:'taxes_to_enable']).is_a?(Array)
          self.taxes_to_enable = value
        end
      end

      if attributes.has_key?(:'taxes_to_disable')
        if (value = attributes[:'taxes_to_disable']).is_a?(Array)
          self.taxes_to_disable = value
        end
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          item_ids == o.item_ids &&
          taxes_to_enable == o.taxes_to_enable &&
          taxes_to_disable == o.taxes_to_disable
    end
    ...
    def hash
      [item_ids, taxes_to_enable, taxes_to_disable].hash
    end
