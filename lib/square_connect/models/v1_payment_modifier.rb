...
module SquareConnect
  ...
  class V1PaymentModifier
    ...
    attr_accessor :modifier_option_id
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'modifier_option_id')
        self.modifier_option_id = attributes[:'modifier_option_id']
      end
    ...
    def hash
      [name, applied_money, modifier_option_id].hash
    end
