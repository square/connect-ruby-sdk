...
module SquareConnect
  ...
  class GetEmployeeWageResponse
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'employee_wage')
        self.employee_wage = attributes[:'employee_wage']
      end
