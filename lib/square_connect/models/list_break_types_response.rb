...
module SquareConnect
  ...
  class ListBreakTypesResponse
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'break_types')
        if (value = attributes[:'break_types']).is_a?(Array)
          self.break_types = value
        end
      end
    ...
    def hash
      [break_types, cursor, errors].hash
    end
