...
module SquareConnect
  ...
  class V1ListPaymentsRequest
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'include_partial')
        self.include_partial = attributes[:'include_partial']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          include_partial == o.include_partial
    end
    ...
    def hash
      [order, begin_time, end_time, limit, batch_token, include_partial].hash
    end
