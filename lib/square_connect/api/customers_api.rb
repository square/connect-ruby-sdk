...
module SquareConnect
  class CustomersApi
    ...
    def create_customer_with_http_info(authorization, body, opts = {})
      ...
      fail ArgumentError, "Missing the required parameter 'authorization' when calling CustomersApi.create_customer" if authorization.nil?
    ...
    def create_customer_card_with_http_info(authorization, customer_id, body, opts = {})
      ...
      # verify the required parameter 'authorization' is set
      fail ArgumentError, "Missing the required parameter 'authorization' when calling CustomersApi.create_customer_card" if authorization.nil?
    ...
    def delete_customer_with_http_info(authorization, customer_id, opts = {})
      ...
      # verify the required parameter 'authorization' is set
      fail ArgumentError, "Missing the required parameter 'authorization' when calling CustomersApi.delete_customer" if authorization.nil?
      # verify the required parameter 'customer_id' is set
    ...
    def delete_customer_card_with_http_info(authorization, customer_id, card_id, opts = {})
      ...
      # verify the required parameter 'authorization' is set
      fail ArgumentError, "Missing the required parameter 'authorization' when calling CustomersApi.delete_customer_card" if authorization.nil?
      # verify the required parameter 'customer_id' is set
    ...
    def list_customers_with_http_info(authorization, opts = {})
      ...
      # verify the required parameter 'authorization' is set
      fail ArgumentError, "Missing the required parameter 'authorization' when calling CustomersApi.list_customers" if authorization.nil?
      # resource path
      local_var_path = "/v2/customers".sub('{format}','json')
    ...
    def retrieve_customer_with_http_info(authorization, customer_id, opts = {})
      ...
      # verify the required parameter 'authorization' is set
      fail ArgumentError, "Missing the required parameter 'authorization' when calling CustomersApi.retrieve_customer" if authorization.nil?
      # verify the required parameter 'customer_id' is set
    ...
    def update_customer_with_http_info(authorization, customer_id, body, opts = {})
      ...
      # verify the required parameter 'authorization' is set
      fail ArgumentError, "Missing the required parameter 'authorization' when calling CustomersApi.update_customer" if authorization.nil?
      # verify the required parameter 'customer_id' is set
