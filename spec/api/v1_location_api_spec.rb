...
# Unit tests for SquareConnect::V1LocationApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'V1LocationApi' do
  before do
    # run before each test
    @instance = SquareConnect::V1LocationApi.new
  end
  ...
  describe 'test an instance of V1LocationApi' do
    it 'should create an instact of V1LocationApi' do
      expect(@instance).to be_instance_of(SquareConnect::V1LocationApi)
    end
  end
